...
- ชั้น 1 "safe": ใช้เงินอิสระปกติ ไม่เกินงบ
...
ลูมิน่า: "เงินอิสระของคุณหลังหักรายจ่ายคงที่คือ X บาท
...
function formatFinanceContextForInsights(context) {
  ...
  if (cf?.hasSalary) {
    ...
    text += `เงินอิสระ (หลังหักคงที่+ออม): ${formatCurrency(cf.freeMoney)} บาท\n`
